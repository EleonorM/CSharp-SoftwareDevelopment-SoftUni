...
namespace SIS.MvcFramework
{
    public abstract class Controller
    {
        ...
        private HttpResponse ViewByName<T>(string viewPath, object viewModel)
        {
            ...
            var notSignedHtml = @"<li class=""nav-item active""><a class=""nav-link"" href =""/Users/Login"">Login</a></li><li class=""nav-item active""><a class=""nav-link"" href =""/Users/Register"" >Register</a></li>";
            var signedHtml = @" <li class=""nav-item active"" ><a class=""nav-link"" href =""/Albums/All"">Albums</a></li><li class=""nav-item active"" ><a class=""nav-link"" href =""/Users/Logout"" > Logout</a></li>";
            if (this.IsUserLoggedIn())
            {
                bodyWithLayout = bodyWithLayout.Replace("@IsSignedHeader", signedHtml);
            }
            else
            {
                bodyWithLayout = bodyWithLayout.Replace("@IsSignedHeader", notSignedHtml);
            }
