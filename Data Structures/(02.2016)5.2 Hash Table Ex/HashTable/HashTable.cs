...
public class HashTable<TKey, TValue> : IEnumerable<KeyValue<TKey, TValue>>, IComparable<TKey>
{
    private LinkedList<KeyValue<TKey, TValue>>[] slots;

    private LinkedList<TKey> order;
    ...
    public HashTable(int capacity = InitialCapacity)
    {
        ...
        this.Count = 0;
        this.order = new LinkedList<TKey>();
    }
    ...
    public void Add(TKey key, TValue value)
    {
        ...
        this.order.AddLast(newElement.Key);
        this.Count++;
    }
        ...
        if (elements != null)
        {
            ...
            while (currentElement != null)
            {
                if (currentElement.Value.Key.Equals(key))
                {
                    ...
                    order.Remove(currentElement.Value.Key);
                    this.Count--;
